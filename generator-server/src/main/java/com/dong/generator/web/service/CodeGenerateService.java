...
//     * @return
//     */
//    List<String> batchGenerate(CodeGenerateParamDTO dto);
//}
//
//@Service
//class CodeGenerateServiceImpl implements CodeGenerateService {
//
//    @Override
//    public List<String> batchGenerate(CodeGenerateParamDTO dto) {
//
//        List<String> result = new ArrayList<>();
//        if (CollectionUtils.isEmpty(dto.getTemplateNameList())) {
//            throw new GlobalException("未选择模块");
//        }
//        String packageName = dto.getPackageName();
//        //根据选择的模板循序生成所有代码
//        for (String templateName : dto.getTemplateNameList()) {
//            dto.setPackageName(getPackageName(packageName, templateName));
//            dto.setTemplateName(templateName);
//
//            //获取元数据
//            for (String tableName : dto.getTableNameList()) {
//                getData(tableName,dto.getTableComment())
//            }
//            for (int i = 0; i < dto.getTableName().size(); i++) {
//                Map<String, Object> data = getData(dto.getTableName().get(i), dto.getTableComment().get(i));
//                String fileName = toCamel(dto.getTableName().get(i));
//                fileName = fileName.substring(0, 1).toUpperCase() + fileName.substring(1) + byTemplateToClassName(templateName);
//                dto.setClassName(fileName);//文件名转成驼峰
//                result.add(generate(data, dto));
//            }
//        }
//        return result;
//    }
...
//     */
//    @NotNull
//    private static String getPackageName(String packageName, String templateName) {
//        String currentPackagePath = templateName.substring(0, templateName.lastIndexOf("."));
//        return packageName + "." + currentPackagePath;
//    }
//
