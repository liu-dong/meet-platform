...
public ResponseResult find${className?cap_first}List(${className?cap_first}DTO dto, Pager
<${className?cap_first}VO> pager) {
    Pager
    <${className?cap_first}VO> result = ${className}Service.find${className?cap_first}List(dto, pager);
