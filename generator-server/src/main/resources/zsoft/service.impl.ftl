...
@Override
public Pager
<${className?cap_first}VO> find${className?cap_first}List(${className?cap_first}DTO dto, Pager
    <${className?cap_first}VO> pager) {
        ...
        List
        <${className?cap_first}ListVO> result = convertVO(page.getContent());
            return new PageImpl<>(result, pageable, page.getTotalElements());
            }

            private List
            <${className?cap_first}ListVO> convertVO(List<${className?cap_first}> content) {
                List
                <${className?cap_first}ListVO> result = new ArrayList<>();
                    ...
                    */
                    @Override
                    public void remove${className?cap_first}(String id) {
                    Vote entity = this.findById(id);
                    if (entity != null) {
