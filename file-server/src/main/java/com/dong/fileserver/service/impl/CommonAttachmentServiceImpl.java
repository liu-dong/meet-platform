...
public class CommonAttachmentServiceImpl implements CommonAttachmentService {
    ...
    @Override
    public String saveAttachmentToMinio(BaseAttachment attachment, String module) {
        //转换文件
    ...
    @NotNull
    private MultipartFile convertMultipartFile(BaseAttachment attachment) {
    ...
    @NotNull
    private String getObjectName(BaseAttachment attachment, String module) {
