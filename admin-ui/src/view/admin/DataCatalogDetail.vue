    ...
    <div class="container">
        ...
        <div class="bottom">
            ...
            >
                ...
                <div class="item-div">
                    <el-table :data="dataCatalog.itemList.filter(item => !item.isDelete || item.isDelete !== 1)"
                        ...
                        <el-table-column prop="itemCode" align="center" width="180" :required="true" label="条目编码">
                            <template slot-scope="{row,$index}">
                                ...
                                <el-input v-else v-model="dataCatalog.itemList[$index].itemCode"
                                          placeholder="请输入条目编码"/>
                            </template>
                        </el-table-column>
                        <el-table-column prop="itemName" align="center" width="180" :required="true" label="条目名称">
                            <template slot-scope="{row,$index}">
                                ...
                                <el-input v-else v-model="dataCatalog.itemList[$index].itemName"
                                          placeholder="请输入条目名称"/>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column prop="status" align="center" width="150" label="状态">
                            <template slot-scope="{row,$index}">
                                <el-select v-model="dataCatalog.itemList[$index].status"
                        ...
                        <el-table-column header-align="center" align="center" width="100" label="操作">
                            <template slot-scope="{row,$index}">
                                <el-button v-if="!isEdit[$index]" @click="edit($index,row)" type="text" size="small">
                                    编辑
                                </el-button>
                                <!--                <el-button type="text" size="small" style="color: red;">取消</el-button>-->
                                <el-button v-if="isEdit[$index]" @click="cancel($index)" type="text" size="small"
                                           style="color: red;">取消
                                </el-button>
...
export default {
    ...
    methods: {
        ...
        deleteItem(index) {
            ...
            let item = this.dataCatalog.itemList[index]
            item.isDelete = 1
