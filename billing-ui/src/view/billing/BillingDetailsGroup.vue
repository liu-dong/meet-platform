    ...
    <div>
        ...
        <el-dialog :visible.sync="dialogTableVisible" title="当日账单明细">
            ...
            <el-table :data="billingDetailsList" :border="true">
                <el-table-column header-align="center" align="center" label="记录时间" a property="recordTime"
                                 width="150"></el-table-column>
                <el-table-column header-align="center" align="center" label="支出类型" property="spendingType"
                                 :formatter="formatterType" width="200"></el-table-column>
                <el-table-column header-align="center" align="right" label="支出金额"
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-button @click="loadBillingDetails(scope.row,'detail')" type="text" size="small">查看
                        </el-button>
                        <el-button @click="loadBillingDetails(scope.row,'edit')" type="text" size="small">编辑</el-button>
                        <el-button type="text" size="small" @click="deleteBillingDetails(scope.row)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </el-dialog>
        ...
        <el-dialog :visible.sync="dialogFormVisible" append-to-body center title="当日账单明细" width="25%">
            <el-form :model="billingDetails" :rules="billingDetailsRules" ref="billingDetailsForm" label-width="80px">
                <el-form-item label="记录时间" prop="recordTime">
                    <el-date-picker :disabled="viewType==='detail'" v-model="billingDetails.recordTime" type="datetime"
                                    format="yyyy-MM-dd HH:mm:ss"
                                    value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择记录时间"
                                    style="width: 100%"></el-date-picker>
                </el-form-item>
                <el-form-item label="支出类型" prop="spendingType">
                    <el-select :disabled="viewType==='detail'" v-model="billingDetails.spendingType"
                ...
                <el-form-item label="支出金额" prop="amountPaid">
                    <el-input :disabled="viewType==='detail'" v-model="billingDetails.amountPaid"
                              autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="备注" prop="remark">
                    <el-input :disabled="viewType==='detail'" v-model="billingDetails.remark"
                              autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer" v-if="viewType!=='detail'">
