  ...
  <div>
    ...
    <el-dialog :visible.sync="dialogFormVisible" append-to-body center title="当日账单明细" width="25%">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="viewType!=='detail'" type="primary" @click="saveBillingDetails('billingDetailsForm')">确
          定
        </el-button>
      </div>
    </el-dialog>
...
import {getCurrentTime} from "@/util/datetime";
...
export default {
  ...
  methods: {
    ...
    formatterType(row) {
      return dataCatalogUtils.getName(row.spendingType, this.spendingTypeOption)
    },
    convertName(name) {
      return dataCatalogUtils.getName(name, this.spendingTypeOption)
    }
  }
}
</script>
